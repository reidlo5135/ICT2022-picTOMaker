		...
		<div className="Footer">
			<div className="Footer-wrap">
				<div className="FooterMenu">
					<p><a href="frontend/src/component/contents/Footer#!">회사소개</a><span>ㅣ</span></p>
					<p><a href="frontend/src/component/contents/Footer#!">개인정보처리방침</a><span>ㅣ</span></p>
					<p><a href="frontend/src/component/contents/Footer#!">이용약관</a><span>ㅣ</span></p>
					<p><a href="frontend/src/component/contents/Footer#!">공지사항</a><span>ㅣ</span></p>
					<p><a href="frontend/src/component/contents/Footer#!">고객센터</a><span>ㅣ</span></p>
					<p><a href="frontend/src/component/contents/Footer#!">FAQ</a></p>
				</div>
