...
export default function Terms(){
    ...
    return (
        <div className='terms'>
            ...
            <div className='terms-title2'>제 2 장 이용계약</div>
            <div ClassNames="group5">
            제 5 조 (이용신청)
            ...
            <div className='terms-title3'>제 3 장 계약 당사자의 의무</div>

            <div ClassNames="group7">
            제 7 조 (회사의 의무)
            ...
            <div className='terms-title4'>제 4 장 서비스의 제공 및 이용</div>

            <div ClassNames="group9">
            제 9 조 (서비스 이용)
            ...
            <div className='terms-title5'>제 5 장 (재화의 주문 및 결제 관련) </div>

            <div ClassNames="group16">
            제16조 (결제방법)
            ...
            <div className='terms-title6'>제 6 장 기타</div>
