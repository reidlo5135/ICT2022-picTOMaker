...
export default function Terms(){
    ...
    return (
        ...
        <div className='terms'>
            <Top/>
            <div className='terms-main-title'><h1>서비스 이용 약관</h1></div>
                <div className='terms-title'><img src={Important} alt="제1장" style={{width:"30px",height:"30px"}}/> 제 1 장 총칙</div>
                
                <div className="group1 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제1조" style={{width:"20px",height:"20px"}}/>
                        제 1 조 (목적)
                    </div>
                    본 약관은 I들(이하 "회사")이 운영하는 웹 사이트 (http://xxx.xxx.xxx)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.
                </div>

                <div className="group2 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제2조" style={{width:"20px",height:"20px"}}/>
                        제 2 조 (용어의 정의)
                    </div>
                ...
                <div className="group3 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제3조" style={{width:"20px",height:"20px"}}/>
                ...
                <div className="group4 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제4조" style={{width:"20px",height:"20px"}}/>
                        제 4 조 (약관 외 준칙)
                    </div>
                ...
                <div className='terms-title'><img src={Important} alt="제2장" style={{width:"25px",height:"25px"}}/>제 2 장 이용계약</div>
                
                <div className="group5 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제5조" style={{width:"20px",height:"20px"}}/>
                        제 5 조 (이용신청)
                    </div>
                    <div className='group-int'>
                ...
                <div className="group6 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제6조" style={{width:"20px",height:"20px"}}/>
                        제 6 조 (이용신청의 승낙)
                    </div>
                    <div className='group-desc'>
                ...
                <div className='terms-title'><img src={Important} alt="제3장" style={{width:"25px",height:"25px"}}/>제 3 장 계약 당사자의 의무</div>

                <div className="group7 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제7조" style={{width:"20px",height:"20px"}}/>
                        제 7 조 (회사의 의무)
                    </div>
                    <div className='group-int'>
                ...
                <div className="group8 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제8조" style={{width:"20px",height:"20px"}}/>
                        제 8 조 (이용자의 의무)
                    </div>
                    <div className='group-desc'>
                ...
                <div className='terms-title'><img src={Important} alt="제4장" style={{width:"25px",height:"25px"}}/>제 4 장 서비스의 제공 및 이용</div>

                <div className="group9 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제9조" style={{width:"20px",height:"20px"}}/>
                        제 9 조 (서비스 이용)
                    </div>
                    <div className='group-int'>
                ...
                <div className="group10 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제10조" style={{width:"20px",height:"20px"}}/>
                        제 10 조 (정보의 제공)
                    </div>
                    회사는 회원이 서비스 이용 중 필요하다고 인정되는 다양한 정보에 대하여 전자메일이나 서신우편 등의 방법으로 회원에게 정보를 제공할 수 있다.
                </div>

                <div className="group11 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제11조" style={{width:"20px",height:"20px"}}/>
                        제 11 조 (광고게재)
                    </div>
                    <div className='group-int'>
                ...
                <div className="group12 group">
                    <div className='group-title'>
                    <img src={Arrow} alt="제12조" style={{width:"20px",height:"20px"}}/>
                    제 12 조 (서비스 이용의 제한)
                    </div>
                    <div className='group-desc'>
                ...
                <div className="group13 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제13조" style={{width:"20px",height:"20px"}}/>
                        제 13 조 (서비스 제공의 중지)
                    </div>
                    <div className='group-desc'>
                ...
                <div className="group14 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제14조" style={{width:"20px",height:"20px"}}/>
                        제 14 조 (게시물 관리)
                    </div>
                ...
                <div className="group15 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제15조" style={{width:"20px",height:"20px"}}/>
                        제 15 조 (서비스 이용 책임)
                    </div>
                ...
                <div className='terms-title'><img src={Important} alt="제5장" style={{width:"25px",height:"25px"}}/>제 5 장 (재화의 주문 및 결제 관련) </div>

                <div className="group16 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제16조" style={{width:"20px",height:"20px"}}/>
                        제16조 (결제방법)
                    </div>
                    <div className='group-desc'>
                ...
                <div className="group17 group">
                    <div className='group-title'>
                        <img src={Arrow} alt="제17조" style={{width:"20px",height:"20px"}}/>
                        제17조 (배송정책)
                    </div>
                    <div className='group-int'>
                ...
                <div className='group18 group'>
                    <div className='group-title'>
                        <img src={Arrow} alt="제18조" style={{width:"20px",height:"20px"}}/>
                        18조 (취소 및 반품 환불 규정)
                    </div>
                    <div className='group-desc'>
                ...
                <div className='terms-title'><img src={Important} alt="제6장" style={{width:"25px",height:"25px"}}/>제 6 장 기타</div>

                <div className='group19 group'>
                    <div className='group-title'>
                        <img src={Arrow} alt="제19조" style={{width:"20px",height:"20px"}}/>
                        제 19 조 (면책 및 손해배상)
                    </div>
                    <div className='group-int'>
                ...
                <div className='group20 group'>
                    <div className='group-title'>
                        <img src={Arrow} alt="제20조" style={{width:"20px",height:"20px"}}/>
                ...
                <div className='group21 group'>
                    <div className='group-title'>
                        <img src={Arrow} alt="제21조" style={{width:"20px",height:"20px"}}/>
                        제 21 조 (분쟁의 해결)
                    </div>
                    <div className='group-int'>
                ...
                <div className='group22 group'>
                <div className='group-title'>
                <img src={Arrow} alt="부칙" style={{width:"20px",height:"20px"}}/>
                &lt; 부칙 &gt;
                </div>
