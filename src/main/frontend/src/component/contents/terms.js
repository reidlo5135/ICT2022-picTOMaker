...
export default function Terms(){
    ...
    return (
        <div className='terms'>
            <div ClassNames="group 1">
                제1조(목적) 이 약관은 I들 회사(이하 “회사”라 한다)가 운영하는 픽토메이커 서비스(이하 “서비스”라 한다)를 이용함에 있어 회사와 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
                ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
            </div>

            <div ClassNames="group 2">
            제2조(정의)
